...
CREATE TABLE `basket` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_basket_car_idx` (`car_id`),
  KEY `fk_basket_user_idx` (`user_id`),
  CONSTRAINT `fk_basket_car` FOREIGN KEY (`car_id`) REFERENCES `car` (`id`),
  CONSTRAINT `fk_basket_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
